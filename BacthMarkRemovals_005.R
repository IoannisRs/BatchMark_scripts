...
N_Avail_true_0.05 = c()
N_Avail_true_0.05 = IndAvail(nij,K)
...
{
  Vij_0.05_with_list = list()
  Vj_0.05_with_list = list()
  p_0.05_with_list = list()
  U_0.05_with_list = list()
  N_0.05_with_list = list()
  w_0.05_with_list = list()
  Ome_0.05_with_list = list()
  
  Vij_0.05_without_list = list()
  Vj_0.05_without_list = list()
  p_0.05_without_list = list()
  U_0.05_without_list = list()
  N_0.05_without_list = list()
  w_0.05_without_list = list()
  Ome_0.05_without_list = list()
}
#true number of available unmarked individuals 
U_Avail_true_0.05_list = list()
...
for(runs in 1:100){
  ...
  M_with_0.05 = Sampled_M
  R_with_0.05 = Sampled_R
  n_0_with_0.05 = sampled_n_0
  p_with_0.05 = p
  abund_with_0.05 = w
  Ome_with_0.05 = Omega_post
  
  p_0.05_with_list[[runs]] = p_with_0.05
  w_0.05_with_list[[runs]] = abund_with_0.05
  Ome_0.05_with_list[[runs]] = Ome_with_0.05
  
  U_Avail_0.05 = matrix(0,length(indic),K)
  for(i in 1:length(indic)){
    U_Avail_0.05[i,] = Unmarked_Available_unif(list(Sampled_M[[1]][,,i],Sampled_M[[2]][,,i],Sampled_M[[3]][,,i],Sampled_M[[4]][,,i],Sampled_M[[5]][,,i],Sampled_M[[6]][,,i],
  ...
  U_0.05_with_list[[runs]] = U_Avail_0.05
  
  N_Avail_0.05 = matrix(0,length(indic),K)
  for(i in 1:length(indic)){
    N_Avail_0.05[i,] = IndAvail(Sampled_M[[1]][,,i]+Sampled_M[[2]][,,i]+Sampled_M[[3]][,,i]+
  ...
  N_0.05_with_list[[runs]] = N_Avail_0.05
  
  U_Avail_true_0.05 = rep(0,K)
  
  U_Avail_true_0.05 = Unmarked_Available_unif(Data$M,Data$R,Data$n_0,K)
  ...
  M_without_0.05 = Sampled_M
  n_0_without_0.05 = sampled_n_0
  p_without_0.05 = p
  abund_without_0.05 = w
  Ome_without_0.05 = Omega_post
  
  p_0.05_without_list[[runs]] = p_without_0.05
  w_0.05_without_list[[runs]] = abund_without_0.05
  Ome_0.05_without_list[[runs]] = Ome_without_0.05
  
  U_Avail_without_0.05 = matrix(0,length(indic),K)
  for(i in 1:length(indic)){
    U_Avail_without_0.05[i,] = Unmarked_Available_unif(list(Sampled_M[[1]][,,i],Sampled_M[[2]][,,i],Sampled_M[[3]][,,i],Sampled_M[[4]][,,i],Sampled_M[[5]][,,i],Sampled_M[[6]][,,i],
                                                           Sampled_M[[7]][,,i],Sampled_M[[8]][,,i],Sampled_M[[9]][,,i],Sampled_M[[10]][,,i],Sampled_M[[11]][,,i]
    ),Data_R,sampled_n_0[,,i],K)
  }  
  
  U_0.05_without_list[[runs]] = U_Avail_without_0.05
  ...
  N_0.05_without_list[[runs]] = N_Avail_0.05
  U_Avail_true_0.05_list[[runs]] = U_Avail_true_0.05
  message(runs)
  
  saveRDS(w_0.05_with_list, file = paste("abund_0.05_with_list_unif_1",".RDS"))
  saveRDS(N_0.05_with_list, file = paste("N_0.05_with_list_unif_1",".RDS"))
  saveRDS(p_0.05_with_list, file = paste("p_0.05_with_list_unif_1",".RDS"))
  saveRDS(U_0.05_with_list, file = paste("U_0.05_with_list_unif_1",".RDS"))
  saveRDS(Ome_0.05_with_list, file = paste("Ome_0.05_with_list_unif_1",".RDS"))
  
  saveRDS(w_0.05_without_list, file = paste("abund_0.05_without_list_unif_1",".RDS"))
  saveRDS(N_0.05_without_list, file = paste("N_0.05_without_list_unif_1",".RDS"))
  saveRDS(p_0.05_without_list, file = paste("p_0.05_without_list_unif_1",".RDS"))
  saveRDS(U_0.05_without_list, file = paste("U_0.05_without_list_1",".RDS"))
  saveRDS(Ome_0.05_without_list, file = paste("Ome_0.05_without_list_1",".RDS"))
  
  saveRDS(U_Avail_true_0.05, file = paste("U_0.05_true_unif_1",".RDS"))
  saveRDS(IndAvel(nij,K), file = paste("N_0.05_true_unif_1",".RDS"))
  saveRDS(wij, file = paste("w_ij_0.05_true_unif_1",".RDS"))
